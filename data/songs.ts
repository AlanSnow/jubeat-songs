...
export const songs: Song[] = [
  ...
  },
  {
    ...
    "firstAppearance": "saucer fulfill",
    "releaseDate": "",
    "deletedDate": "",
    "deletedIn": "",
    "isLicense": true,
  ...
  },
  {
    ...
    "firstAppearance": "Beyond the Ave.",
...
export const stats = {
  ...
  byVersion: {
    ripples: songs.filter(s => s.firstAppearance === 'ripples').length,
    knit: songs.filter(s => s.firstAppearance === 'knit').length,
    copious: songs.filter(s => s.firstAppearance === 'copious').length,
    saucer: songs.filter(s => s.firstAppearance === 'saucer').length,
    'saucer fulfill': songs.filter(s => s.firstAppearance === 'saucer fulfill').length,
    prop: songs.filter(s => s.firstAppearance === 'prop').length,
    Qubell: songs.filter(s => s.firstAppearance === 'Qubell').length,
    clan: songs.filter(s => s.firstAppearance === 'clan').length,
    festo: songs.filter(s => s.firstAppearance === 'festo').length,
    'Ave.': songs.filter(s => s.firstAppearance === 'Ave.').length,
    'Beyond the Ave.': songs.filter(s => s.firstAppearance === 'Beyond the Ave.').length,
  }
};
