...
import { songs, allGenres, allLevels } from '@/data/songs';
...
export default function Home() {
  ...
  const fuse = useMemo(() => {
    return new Fuse(songs, {
      keys: ['title', 'titleRomaji', 'titleChinese', 'artist'],
      threshold: 0.3,
    });
  }, []);
  ...
  const filteredSongs = useMemo(() => {
    ...
    return result;
  }, [searchQuery, selectedGenre, selectedLevel, fuse]);
  ...
  return (
    <main className="min-h-screen p-4 md:p-8">
      ...
      <header className="mb-8 text-center">
        ...
        <p className="text-gray-600">jubeat Ave. 曲目数据库 | 共 {songs.length} 首曲目</p>
      </header>
        ...
        {filteredSongs.map((song) => (
          ...
          >
            ...
            <div className="p-4 border-b">
              ...
              {song.titleChinese && (
                <p className="text-sm text-gray-500">{song.titleChinese}</p>
              )}
            ...
            <div className="grid grid-cols-3 divide-x">
              ...
              <div
                className={`p-3 text-center ${
                  song.difficulties.extreme.rating ? 'bg-red-50' : 'bg-red-50'
                }`}
              >
                ...
                {song.difficulties.extreme.rating && (
                  <div className="text-xs text-red-600 font-semibold mt-1">
                    ⚠️ {song.difficulties.extreme.rating}
                  </div>
                )}
              </div>
            </div>
      ...
      <footer className="mt-12 py-6 text-center text-gray-500 text-sm">
        <p>Jubeat 曲目查询系统 | 数据来源: jubeat Ave.</p>
